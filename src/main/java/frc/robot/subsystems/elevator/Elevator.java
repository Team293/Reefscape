...
public class Elevator extends SubsystemBase {
    ...
    private static final double L1_POSITION = 0.1d;
    private static final double L2_POSITION = 1.05d;
    private static final double L3_POSITION = 3.32d;
    private static final double L4_POSITION = 0.1d;
